...
def position_abbr(position):
    long_positions = {
        'PRO': 'Pro-Style Quarterback', 'DUAL': 'Dual-Threat Quarterback', 'APB': 'All-Purpose Back', 'RB': 'Running Back', 'FB': 'Fullback', 'WR': 'Wide Receiver', 'TE': 'Tight End',
        ...
        'RET': 'Returner', 'QB': 'Quarterback', 'IOL': 'Interior Offensive Lineman', 'Edge': 'Edge', 'LB': 'Linebacker',
        'DL': 'Defensive Lineman'
    }
    return long_positions[position]  # updated keys
...
class Recruit:
    ...
    def __init__(
            self=None, x247_highlights=None, x247_profile=None, all_time_ranking=None, bio=None, city=None, commitment_date=None, committed=None, committed_school=None, early_enrollee=None,
...
def FootballRecruit(year, name):
    ...
    def collect_ranks(player_url):
        ranks_requests_raw = requests.get(url=player_url, headers=HEADERS)
