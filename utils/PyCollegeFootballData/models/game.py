...
class Game(object):
    ...
    def __init__(self, id=None, season=None, week=None, season_type=None, start_date=None, neutral_site=None, conference_game=None, attendance=None, venue_id=None, venue=None, home_team=None, home_conference=None, home_points=None, home_line_scores=None, away_team=None, away_conference=None, away_points=None, away_line_scores=None):  # noqa: E501
