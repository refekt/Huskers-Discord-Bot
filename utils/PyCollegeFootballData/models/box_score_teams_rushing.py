...
class BoxScoreTeamsRushing(object):
    ...
    def __init__(self, team=None, power_success=None, stuff_rate=None, second_level_yards=None, second_level_yards_average=None, open_field_yards=None, open_field_yards_average=None):  # noqa: E501
