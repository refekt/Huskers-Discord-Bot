...
class Play(object):
    ...
    def __init__(self, id=None, drive_id=None, offense=None, offense_conference=None, offense_score=None, defense=None, home=None, away=None, defense_conference=None, defense_points=None, period=None, clock=None, yard_line=None, down=None, distance=None, yards_gained=None, play_type=None, play_text=None):  # noqa: E501
