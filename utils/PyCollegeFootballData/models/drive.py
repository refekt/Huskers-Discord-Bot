...
class Drive(object):
    ...
    def __init__(self, offense=None, offense_conference=None, defense=None, defense_conference=None, id=None, game_id=None, scoring=None, start_period=None, start_yardline=None, start_time=None, end_period=None, end_yardline=None, end_time=None, plays=None, yards=None, drive_result=None):  # noqa: E501
