...
class BettingApi(object):
    ...
    def get_lines(self, year, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.get_lines_with_http_info(year, **kwargs)  # noqa: E501
        else:
            (data) = self.get_lines_with_http_info(year, **kwargs)  # noqa: E501
            return data

    def get_lines_with_http_info(self, year, **kwargs):  # noqa: E501
        """Get betting line information  # noqa: E501

        Closing betting lines  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_lines_with_http_info(year, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['year', 'week', 'season_type', 'team', 'home', 'away', 'conference']  # noqa: E501
        ...
        if ('year' not in params or
                params['year'] is None):
            raise ValueError("Missing the required parameter `year` when calling `get_lines`")  # noqa: E501
